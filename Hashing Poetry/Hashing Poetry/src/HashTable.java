...
public class HashTable<E, S>
{
     ...
     */
    public boolean insert( E key, S element )
    {
        // Insert x as active
    ...
    private void rehash( )
    {
        ...
        // Copy table over
        for( HashEntry<E, S> entry : oldArray )
    ...
    private static class HashEntry<E, S>
    {
        public E key;   // the element
        public S element;
        public boolean isActive;  // false if marked deleted

        public HashEntry( E k , S e)
        {
            this( k ,e,true );
        }

        public HashEntry( E k, S e ,boolean i )
        {
            key = k;
            element = e;
            isActive = i;
    ...
    private HashEntry<E, S> [ ] array; // The array of elements
...
//
//        //This one makes sure that you cant insert the same thing twice I believe
//        for( int i = GAP; i != 0; i = ( i + GAP ) % NUMS )
//            if( H.insert( ""+i , "bye" + i) )
